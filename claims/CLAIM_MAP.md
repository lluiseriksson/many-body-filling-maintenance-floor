...
| Lemmas 5.2–5.4, crossing norms, uniform leakage, and free-energy sandwich | Analytic semigroup and block-entropy estimates after separately requiring an isolated spectral code band and invariance of the block-diagonal algebra; full commutation with block dephasing is not assumed | Source invariants and limiting weights are checked |
